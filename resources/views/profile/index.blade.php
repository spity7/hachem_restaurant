            ...
            <form action="{{ route('profile.update') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text"
                        name="last_name" id="last_name" value="{{ old('last_name', auth()->user()->last_name) }}" required>
        ...
        <div class="card-body">
            <form action="{{ route('profile.changePassword') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('old_password') ? 'is-invalid' : '' }}" type="password"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('new_password') ? 'is-invalid' : '' }}" type="password"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('new_password_confirmation') ? 'is-invalid' : '' }}"
