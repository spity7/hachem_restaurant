        ...
        <div class="card-body">
            <form action="{{ route('suppliers.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="string"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="string"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('shop_name') ? 'is-invalid' : '' }}" type="string"
